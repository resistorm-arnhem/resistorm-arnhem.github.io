...
var canvasLightning = function (c, cw, ch) {
    ...
    this.renderL = function () {
        ...
        while (i--) {
            ...
            this.ctx.strokeStyle = 'hsla(180, 35.7%, 48.8%, ' + this.rand(10, 100) / 100 + ')';
            ...
            if (!light.hasFired) {
                this.ctx.fillStyle = 'rgba(80, 169, 169, ' + this.rand(4, 12) / 100 + ')';
                this.ctx.fillRect(0, 0, this.cw, this.ch);
            }

            if (this.rand(0, 30) == 0) {
                this.ctx.fillStyle = 'rgba(80, 169, 169, ' + this.rand(1, 3) / 100 + ')';
                this.ctx.fillRect(0, 0, this.cw, this.ch);
            }
